        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 md:order-1 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/30 transition-all duration-300">
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0">
                  <Shield className="w-5 h-5 text-white" />
                </div>
                <div>
                  <div className="text-sm font-bold text-white mb-1" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Quality Assured</div>
                  <div className="text-xs text-slate-300" style={{ fontFamily: 'Raleway, sans-serif' }}>Auction grade vehicles</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/30 transition-all duration-300">
                ...
                <div>
                  <div className="text-sm font-bold text-white mb-1" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Direct Access</div>
                  <div className="text-xs text-slate-300" style={{ fontFamily: 'Raleway, sans-serif' }}>Japan auction network</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/30 transition-all duration-300">
                ...
                <div>
                  <div className="text-sm font-bold text-white mb-1" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>JDM Specialists</div>
                  <div className="text-xs text-slate-300" style={{ fontFamily: 'Raleway, sans-serif' }}>Crown, Mark X, Lexus</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/30 transition-all duration-300">
                ...
                <div>
                  <div className="text-sm font-bold text-white mb-1" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Affordable Luxury</div>
                  <div className="text-xs text-slate-300" style={{ fontFamily: 'Raleway, sans-serif' }}>Premium under $20k</div>
                </div>
              </div>
            </div>
            ...
            {/* CTA */}
            <div className="pt-6">
              <button className="group relative px-8 py-4 bg-white hover:bg-slate-100 transition-all duration-300 rounded-full overflow-hidden shadow-lg">
        ...
        <div className="mt-24 pt-12 border-t border-white/10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center group cursor-pointer">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/20">
                <CheckCircle className="w-8 h-8 text-white" />
              </div>
              <div className="text-2xl font-black text-white mb-2" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Authentic</div>
              <div className="text-sm text-gray-400" style={{ fontFamily: 'Raleway, sans-serif' }}>Direct from Japan auctions</div>
            </div>
            ...
            <div className="text-center group cursor-pointer">
              ...
              <div className="text-2xl font-black text-white mb-2" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Transparent</div>
              <div className="text-sm text-gray-400" style={{ fontFamily: 'Raleway, sans-serif' }}>Full auction sheets provided</div>
            </div>
            ...
            <div className="text-center group cursor-pointer">
              ...
              <div className="text-2xl font-black text-white mb-2" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Student Friendly</div>
              <div className="text-sm text-gray-400" style={{ fontFamily: 'Raleway, sans-serif' }}>Affordable premium imports</div>
            </div>
            ...
            <div className="text-center group cursor-pointer">
              ...
              <div className="text-2xl font-black text-white mb-2" style={{ fontFamily: 'var(--font-chakra-petch), sans-serif' }}>Efficient</div>
              <div className="text-sm text-gray-400" style={{ fontFamily: 'Raleway, sans-serif' }}>Streamlined delivery</div>
            </div>
          </div>
        </div>
      </div>
