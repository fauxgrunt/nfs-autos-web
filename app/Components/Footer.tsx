...
const Footer = () => {
  return (
    <footer className="relative bg-[#0a0a0a] overflow-hidden w-full">
      ...
      {/* Main Footer Content */}
      <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-12 py-16 max-w-7xl">
        <div className="grid grid-cols-2 gap-6 md:gap-8 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2 group break-words" style={{ fontFamily: 'Raleway, sans-serif' }}>
      ...
      <div className="border-t border-white/10 relative z-10">
        <div className="container mx-auto px-4 md:px-6 lg:px-12 py-6 max-w-7xl">
