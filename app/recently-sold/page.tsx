      ...
      <main className="flex min-h-screen w-full overflow-x-hidden pt-24">
        ...
        <>
          ...
          >
              ...
              {/* Apply Button - Outside scrollable area */}
              <div className="flex-shrink-0 p-6 bg-[#0a0a0a] border-t border-white/10">
                <button
                  onClick={() => setShowMobileFilters(false)}
                  className="w-full py-4 bg-white text-[#0b1d38] font-ui font-bold text-xs uppercase tracking-widest hover:bg-white/90 transition-all"
                >
                  Apply Filters
                </button>
              </div>
